# Web Development Curriculum with Python (Forked and Modified KnowRe WebDevCurriculum)


## 소개
* 이 커리큘럼은 KnowRe의 신입 웹 개발자 교육을 위한 웹 개발 교육 커리큘럼을 Python 환경으로 개량한 커리큘럼입니다.
* 이 커리큘럼을 통해 신입 개발자들은 git, HTML, CSS, front-end JavaScript, Python, Flask, MySQL, 그리고 더 나아가 선택된 몇 가지의 최신 웹 기술과 그 작동 원리에 대해 익히게 됩니다.
...
* 코딩을 하면서 커밋의 기준을 어떻게 잡는지 고민하는 것도 중요합니다.
* Checklist에 대한 대답과 Quest의 결과물(Skeleton code 위에 덧붙여진)을 제출한 뒤 교수자에게 메일 등을 통해 알려주시면 됩니다.
